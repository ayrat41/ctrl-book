    ...
    <div className="grid gap-6">
      ...
      <div className={cn(Theme.classes.cardGlass, "p-6")}>
        ...
        <p className="text-xs font-semibold mb-4 opacity-70">
          Available tags: {"{{customerName}}"}, {"{{studioName}}"},{" "}
          {"{{locationName}}"}, {"{{time}}"}
        </p>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  smsConfirmationTemplate: e.target.value,
                })
              }
            />
          </div>
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  smsReminderTemplate: e.target.value,
                })
              }
            />
          </div>
      ...
      <div className={cn(Theme.classes.cardGlass, "p-6")}>
        ...
        <p className="text-xs font-semibold mb-4 opacity-70">
          Note: To edit the full email HTML content, modify the React Email
          components in src/emails.
        </p>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  emailConfirmationSubject: e.target.value,
                })
              }
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  emailReminderSubject: e.target.value,
                })
              }
            />
          </div>
      ...
      <div className="flex justify-end mt-4">
        <button
          onClick={handleSave}
          disabled={saving}
          className="flex items-center gap-2 bg-brand-black dark:bg-brand-latte text-brand-latte dark:text-brand-black px-6 py-3 rounded-xl  transition-transform hover:scale-105 active:scale-95 disabled:opacity-50"
        >
